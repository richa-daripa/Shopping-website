...
const Cart = () => {
  const {cartItems,itemList,addToCart,removeFromCart,getTotalAmount,handleDelete,handleDeleteConfirm,delConfirm,showDelConfirm,totalQuantity} = useContext(StoreContext);
  ...
  return (
    <div className="container">
      ...
      <Modal
        ...
        centered
      >
        <Modal.Body className=" d-flex flex-column gap-3 m-2">
          <div className="text-center">
            <h5>Are you sure you want to remove this item from your cart?</h5>
          </div>
          <div className="d-flex justify-content-center align-items-center ">
            <Button className="me-5 w-25 bg-secondary-subtle text-secondary border-0 " onClick={() => showDelConfirm(false)} >
              Cancel
            </Button>
            <Button
              className="w-25 bg-danger-subtle text-danger border-0"
